...
def _load_collections() -> dict[str, Any]:
    ...
    if _collections_cache is not None and COLLECTIONS_FILE.exists():
        try:
            ...
            logging.info("Collections file modified, reloading...")
    ...
    try:
        ...
        logging.exception(f"Error loading collections file: {e!s}")
        return {"collections": [], "totalCollections": 0}
...
def get_oldest_movie_id(collection: dict[str, Any]) -> int | None:
    """
