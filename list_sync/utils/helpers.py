...
def construct_list_url(list_type: str, list_id: str) -> str:
    ...
    if list_type.lower() in ["trakt", "trakt_special"]:
    ...
    if list_type.lower() == "collections":
