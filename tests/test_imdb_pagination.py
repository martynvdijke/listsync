...
class FakeElement:
    ...
    def find_element(self, _by, selector):
        if selector in (".ipc-title__text", "h3.ipc-title__text", "a.ipc-title-link-wrapper h3", ".dli-title h3"):
...
def make_rows(specs):
    ...
    return [FakeElement(title=t, href=f"https://www.imdb.com/title/{i}/") for t, i in specs]
...
class FakeSB:
    ...
    def __init__(self, pages, stuck=False, has_total=False, has_pagination=False, scroll_batches=None):
        self.pages = pages
        self.stuck = stuck
...
sb = FakeSB([[]], stuck=True, has_total=False, has_pagination=False, scroll_batches=batches)
result, error = with_timeout(30, _process_imdb_list, sb, "https://www.imdb.com/user/ur171928620/watchlist")
...
sb = FakeSB(
    [[]], stuck=True, has_total=False, has_pagination=False, scroll_batches=[make_rows([("1. Only", "tt0000001")])]
)
result, error = with_timeout(30, _process_imdb_list, sb, "https://www.imdb.com/user/ur1/watchlist")
